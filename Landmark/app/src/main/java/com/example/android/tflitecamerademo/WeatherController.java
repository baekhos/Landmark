...
public class WeatherController extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton changeStartButton = (ImageButton) findViewById(R.id.changeStartButton);
        mLatitudeLabel= (TextView) findViewById(R.id.latitudeTextView);
        mLongitudeLabel= (TextView) findViewById(R.id.longitudeTextView);
        ImageButton toMapsButton = (ImageButton) findViewById(R.id.toMapsButton);
        ...
        mLongitudeLabel.setText("Longitude" +longitude.substring(0,4));
        ...
        changeStartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent= new Intent(WeatherController.this, Start.class);
